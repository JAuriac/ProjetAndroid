...
public class Tab1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Tab1Fragment.RetrieveFeedTask().execute();
        return mContainer;
    }
    ...
    class RetrieveFeedTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            ...
            try {
                String urlString ="http://aligulac.com/api/v1/player/?apikey=c2eU3jUSzazkm9JmkOy4&current_rating__isnull=false&current_rating__decay__lt=4&order_by=-current_rating__rating&limit=10";
